...
This page gives one clean entry point per language.

## Ready-To-Inspect Outputs

| Language | Status | Primary files |
|---|---|---|
...
| Language | Bundle |
|---|---|
| Turkish | [v4.0 consistency/usability ZIP](../data/releases/turkish_quran_arabic_script_v4_0_consistency_usability.zip) |
| Azeri/Azerbaijani | [Production v1 ZIP](../data/releases/azeri_quran_arabic_script_production_v1.zip) / [v2 Perso-Arabic starter ZIP](../data/releases/azeri/azeri_v2_perso_arabic_start.zip) |
| Kazakh | [Production v1 ZIP](../data/releases/kazakh_quran_arabic_script_production_v1.zip) / [App-final beta ZIP](../data/releases/kazakh/kazakh_app_final_bundle.zip) |
| Kyrgyz | [QA production v1 beta ZIP](../data/releases/kyrgyz/kyrgyz_quran_arabic_script_v1_qa_production.zip) |
| Uzbek | [v2 production fixed beta ZIP](../data/releases/uzbek/uzbek_quran_arabic_script_v2_production_fixed.zip) |
